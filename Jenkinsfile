pipeline {
    ...
    environment {
        PROJECT_ID = 'saisreekanth'
        GOOGLE_APPLICATION_CREDENTIALS = credentials('sevice-account-jenkins')  // Service account credential
    }

    stages {
        stage('Clone Repository') {
            steps {
                git branch: 'main', url: 'https://github.com/GollaGiddaiah/jenkin-demo.git'
            }
        }
